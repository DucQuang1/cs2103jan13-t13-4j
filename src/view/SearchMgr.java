...
public class SearchMgr {
	...
	public SearchMgr(){
		...
		frame.setBounds(100, 100, 680, 450);
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

		final JScrollPane searchMgrFullPane_SCP = new JScrollPane();				//ScrollPane to enable scrolling in window
		frame.getContentPane().add(searchMgrFullPane_SCP);
		
		final JPanel searchMgrFullPanel_PNL = new JPanel(new MigLayout(				//Panel that contains all the GUI elements in window
				"", 
				"[50px:n:50px][50:n:100][100px:n:100px][100px:n:100px][100px:n:100px][100px:n:100px][grow]", 
				"[][][][][][][][][][][][grow][grow]"));
		searchMgrFullPane_SCP.setViewportView(searchMgrFullPanel_PNL);

		final JScrollPane searchMgrScPane_SCP = new JScrollPane();					//ScrollPane to put the results Panel into it and to display results
		searchMgrFullPanel_PNL.add(searchMgrScPane_SCP, "cell 0 11 7 2,grow");
		...
		searchMgrFullPanel_PNL.add(searchMgrDisplay_LBL, "cell 2 10 3 1");
		
		JRadioButton searchMgrSelectionAmount_RDBTN = new JRadioButton("");			//Radio button to specify search by amount
		searchMgrFullPanel_PNL.add(searchMgrSelectionAmount_RDBTN, "cell 0 2");
		...
		searchMgrFullPanel_PNL.add(searchMgrAmount_CB, "cell 1 2 2 1");
		...
		searchMgrFullPanel_PNL.add(searchMgrDate_CB, "cell 1 5 2 1");
		...
		searchMgrFullPanel_PNL.add(searchMgrType_LBL, "cell 1 8 2 1,alignx left");
		
		final JComboBox<String> searchMgrType_CB = new JComboBox<String>();			//Combo box for selecting the type of transaction type
		searchMgrFullPanel_PNL.add(searchMgrType_CB, "cell 3 8 2 1,growx");
		...
		searchMgrFullPanel_PNL.add(searchMgrSearchNow_BTN, "cell 6 10,alignx center");
		/*
