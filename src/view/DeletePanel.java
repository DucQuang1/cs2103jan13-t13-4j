...
public class DeletePanel {
	...
	public DeletePanel(final JFrame hostFrame, final AssetCatMgr assetCatMgr, final LiabilityCatMgr liabilityCatMgr,
		...
		switch(entry.getTransactionType()){
			case 0:	deletePanel.setBackground(new Color(160, 190, 220, 50));
					break;
			case 1:
			case 2:	deletePanel.setBackground(new Color(255, 200, 0, 50));
					break;
			case 3:
			case 4:	deletePanel.setBackground(new Color(255, 185, 215, 50));
					break;
			case 5:
			case 6:	deletePanel.setBackground(new Color(60, 160, 0, 50));
					break;
		}
