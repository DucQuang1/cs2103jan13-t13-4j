...
public class HistoryMgr {
	...
	private final String txt_path = "History.txt";
	 ...
	 * Deletes any category that was created during the add operation 
	 * by checking if any entries still have that category
	 * @param id
	 * @param transactionType
	 * @param amount
	 * @param category1
	...
	private boolean undoAdd(int id, int transactionType, double amount, String category1, String category2) {
		...
		switch(transactionType){
			...
			case 4:	assetCatMgr.addAmountToCategory(category1, -amount);
					if(!entryMgr.checkCategoryExists(0, category1))
						assetCatMgr.deleteCategory(category1);
					break;
			case 1:
			case 3:
			...
			case 2:	liabilityCatMgr.addAmountToCategory(category1, -amount);
					if(!entryMgr.checkCategoryExists(1, category1))
						liabilityCatMgr.deleteCategory(category1);
					break;
		...
		switch(transactionType){
			case 0: incomeCatMgr.addAmountToCategory(category2, -amount);
					if(!entryMgr.checkCategoryExists(2, category2))
						incomeCatMgr.deleteCategory(category2);
					break;
			case 1:
			case 2:	expenseCatMgr.addAmountToCategory(category2, -amount);
					if(!entryMgr.checkCategoryExists(3, category2))
						expenseCatMgr.deleteCategory(category2);
					break;
			case 3:	liabilityCatMgr.addAmountToCategory(category2, amount);
					if(!entryMgr.checkCategoryExists(1, category2))
						liabilityCatMgr.deleteCategory(category2);
					break;
			case 4:
			...
			case 5:	assetCatMgr.addAmountToCategory(category2, -amount);
					if(!entryMgr.checkCategoryExists(0, category2))
						assetCatMgr.deleteCategory(category2);
					break;
		}
